...
function [electrodogramMatrix, p, q] = ACE_Process_CI(x, p,sampling_fre)
...
cd 'C:\Users\asb180001\Documents\GitHub\CCi-MOBILE\MATLAB\Speech Enhancement Demo\CCi Mobile'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
% cd 'C:\Users\nxm175730\Documents\Mamun\LAB\Program Matlab\CCiMobileVersions\CCiMobile_Ver2.2c\CommonFunctions'
q.electrodes(q_is_idle) = 0;
