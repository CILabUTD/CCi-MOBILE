...
%   Authors: Hussnain Ali, Juliana N. Saba
%      Date: 2015/09/28
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
MAP.Right.StimulationRate   = 1450;             % Stimulation rate per electrode in number of pulses per second (pps)
MAP.Right.PulseWidth        = 30;               % Pulse width in us
...
MAP.Right.Gain              = 35;               % Global gain for envelopes in dB - standard is 25dB (adjustable in GUI)
